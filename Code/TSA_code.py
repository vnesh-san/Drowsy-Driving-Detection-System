...
groups = series_train['2017-12-19 23:10:00':'2017-12-19 23:17:35'].groupby(TimeGrouper('S'))
...
stationary = difference(X, 1,Seconds_in_minute)

stationary.index = series_train.index[Seconds_in_minute:]
...
for i in range(len(test)):
    diff = difference(history,0,Seconds_in_minute)
    # predict
    ...
    print(yhat)
    yhat = inverse_difference(history, yhat, Seconds_in_minute)
    predictions.append(yhat)
